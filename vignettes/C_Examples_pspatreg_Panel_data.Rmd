...
##            Estimate Std. Error   t value Pr(>|t|)
## empgrowth -0.177647   0.018747 -9.476139   0.0000
## partrate   0.536324   0.034517 15.537976   0.0000
## agri      -0.049446   0.038098 -1.297852   0.1943
## cons      -0.224605   0.060875 -3.689593   0.0002
## serv       0.018060   0.028347  0.637128   0.5240
## 
##  Direct Parametric Impacts (sar) 
##            Estimate Std. Error   t value Pr(>|t|)
## empgrowth -0.133674   0.013674 -9.775695   0.0000
## partrate   0.403553   0.023602 17.098458   0.0000
## agri      -0.037201   0.028663 -1.297862   0.1943
## cons      -0.169028   0.045745 -3.695026   0.0002
## serv       0.013595   0.021346  0.636871   0.5242
## 
##  Indirect Parametric Impacts (sar) 
##             Estimate Std. Error    t value Pr(>|t|)
## empgrowth -0.0439721  0.0061546 -7.1445419   0.0000
## partrate   0.1327714  0.0149574  8.8766046   0.0000
## agri      -0.0122448  0.0095139 -1.2870437   0.1981
## cons      -0.0555776  0.0158241 -3.5122181   0.0004
## serv       0.0044656  0.0070336  0.6348952   0.5255
```
...
## delta        0.751408   0.010967  68.5127  < 2e-16 ***
## ---
## Signif. codes:  
## 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
##  Parametric Terms 
##              Estimate Std. Error t value  Pr(>|t|)    
## Intercept  5.0675604  3.0611609  1.6554   0.09797 .  
## partrate   0.1485791  0.0205497  7.2302 6.555e-13 ***
## agri      -0.0349064  0.0201957 -1.7284   0.08405 .  
## cons      -0.0092443  0.0411775 -0.2245   0.82239    
## rho        0.0454491  0.0218250  2.0824   0.03741 *  
## phi        0.3149484  0.0138865 22.6802 < 2.2e-16 ***
## ---
## Signif. codes:  
## 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## gamsar -3874.5 -3885.9 17.588 7784.2 7909.0   1685     0
```
...
##                  logLik rlogLik     edf    AIC    BIC
## gam             -4719.1 -4728.3  13.196 9464.6 9559.7
## sp3danova_restr -2809.0 -2808.1 211.915 6041.8 7252.9
##                 LRtest p.val
## gam                         
## sp3danova_restr 3840.4     0
```
...
```
##                  logLik rlogLik    edf    AIC    BIC
## sp3danova_restr -2809.0 -2808.1 211.91 6041.8 7252.9
## sp3danovasarar1 -2593.6 -2593.1 197.53 5582.3 6713.1
```
...
##  Total Parametric Impacts (sar) 
##           Estimate Std. Error   t value Pr(>|t|)
## partrate  0.156344   0.022278  7.017783   0.0000
## agri     -0.035473   0.021603 -1.642025   0.1006
## cons     -0.010993   0.043013 -0.255582   0.7983
## 
##  Direct Parametric Impacts (sar) 
##           Estimate Std. Error   t value Pr(>|t|)
## partrate  0.149230   0.021038  7.093247   0.0000
## agri     -0.033847   0.020609 -1.642382   0.1005
## cons     -0.010499   0.041051 -0.255759   0.7981
## 
##  Indirect Parametric Impacts (sar) 
##             Estimate  Std. Error     t value Pr(>|t|)
## partrate  0.00711368  0.00349444  2.03571345   0.0418
## agri     -0.00162614  0.00131286 -1.23862636   0.2155
## cons     -0.00049413  0.00216195 -0.22855802   0.8192
```
